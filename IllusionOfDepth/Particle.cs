...
namespace IllusionOfDepth
{
    public class Particle
    {
        ...
        {
            m_Animation = new Animation(spriteTexture);
        ...
        public void UpdatePos(GameTime gameTime)
        {
            ...
            m_Animation.mSpritePosition = m_vPos;
        }
        ...
        public void UpdateRot(GameTime gameTime)
        {
            ...
            //m_Animation.m_fRotation = m_fRot;
        }
